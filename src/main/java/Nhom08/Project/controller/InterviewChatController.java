...
import Nhom08.Project.service.ClaudeService;
...
/**
 * REST controller for AI mock interview chat.
 * POST /api/interview/chat  — sends conversation history, returns Claude's next message.
...
public class InterviewChatController {
    ...
    public ResponseEntity<Map<String, Object>> chat(@RequestBody Map<String, Object> req) {
        try {
            ...
            String system = buildSystemPrompt(role, level, type, hasCV, cvContext);
            String reply  = claudeService.chat(system, messages, 800);
    ...
    private String buildSystemPrompt(String role, String level, String type,
                                      boolean hasCV, String cvContext) {
        ...
        return """
            ...
            """.formatted(role, level, typeDesc, cvSection);
    }
